...
const SupplierCard = ({ id, name, phone, adress, city, identification, postalCode, createdAt, updatedAt }) => {
  return (
    <Link href={`/shopping/files/update/${id}`}>
      <div className="bg-gray-200 flex flex-wrap justify-between p-4 border border-gray-300 shadow-md rounded-md mt-4 w-full">
        ...
        <div className="flex flex-wrap justify-between w-3/4">
          ...
          <div className="w-1/3">
            ...
            <p className="text-gray-600">Identificación: {identification}</p>
          </div>
        </div>
      </div>
    </Link>
